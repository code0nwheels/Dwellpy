...
DEFAULT_SETTINGS = {
    ...
    'widget_unlock_threshold': WIDGET_UNLOCK_THRESHOLD_DEFAULT,    'contract_ui_enabled': False,
    'expansion_direction': DEFAULT_EXPANSION_DIRECTION,
    'click_color_left': '#00e676',
    'click_color_right': '#ff9800',
    'click_color_double': '#e91e63',
    'polling_normal_interval': 100,
    'polling_idle_interval': 500,
    'polling_idle_threshold': 10,
